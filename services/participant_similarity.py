"""Сходство участника с другими в тех же чатах: профили P-1 (OCEAN), иначе эвристика по полит. позиции и связям."""
        ...
        out.append(
            {
                ...
                "peer_id": peer,
                "score": round(score, 3),
                "hint": "По полит. позиции и активности переписки (профиль OCEAN ещё не строился).",
                "source": "heuristic",
            }
        )
    return out
